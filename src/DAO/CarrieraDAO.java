...
public class CarrieraDAO {
    ...
    public CarrieraDAO(Connection connection) {
        this.connection = connection;
    }

    public Carriera getCarrieraById(int id, String nomeSquadra, Date dataInizioCarriera) throws SQLException {
        String sql = "SELECT * FROM Carriera WHERE ID = ? AND nomeSquadra = ? AND dataInizioCarriera = ?";
